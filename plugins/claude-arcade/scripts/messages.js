...
const MESSAGES = {
  ...
  space: {
    ...
    summon: {
      Mage: ['🧙 A science officer beams aboard: {desc}'], Ranger: ['🔭 Scout ship away: {desc}'],
      Knight: ['🛡 Security team deployed: {desc}'], Warlock: ['🔮 A void navigator joins the bridge: {desc}'],
      Bard: ['📡 Comms officer on the line: {desc}'], Rogue: ['🗡 A stealth pilot slips into the hangar: {desc}'],
    },
  ...
  retro: {
    ...
    summon: { MAGE: ['{desc} - MAGE JOINS!'], RANGER: ['{desc} - RANGER JOINS!'], KNIGHT: ['{desc} - KNIGHT JOINS!'], WARLOCK: ['{desc} - WARLOCK JOINS!'], BARD: ['{desc} - BARD JOINS!'], ROGUE: ['{desc} - ROGUE JOINS!'] },
